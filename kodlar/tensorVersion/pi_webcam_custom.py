...
while True:
    ...
    for i in range(len(scores)):
        if ((scores[i] > min_conf_threshold) and (scores[i] <= 1.0)):
            ...
            # servoların kontrolü için yazılacak olan fonksiyona bu x, y değerleri gerekmektedir.
            ...
            # control servos
            controlServos(ymin, xmin, ymax, xmax)
    ...
    cv2.resizeWindow("object detector", 600,600)
